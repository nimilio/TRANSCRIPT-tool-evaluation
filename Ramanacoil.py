...
def evaluation(cipher_dict, golden_dict):
    ...
    res = dict()
    for (k,v), (k2,v2) in zip(sorted_total_test.items(), sorted_total_gold.items()):
        if k in sorted_total_gold and k!= "untranscribed":
            res[k] = v*100 / sorted_total_gold[k]
...
# Runic model
decrypt_dicts(Ramanacoil_decrypt, "Ramanacoil/Runic/Ramanacoil_1shot_4trsh")
tuples(Ramanacoil_Golden, Ramanacoil_decrypt, tuple_gold)
ser(Ramanacoil_decrypt, tuple_gold)
decrypt_dicts(Ramanacoil_decrypt, "Ramanacoil/Runic/Ramanacoil_1shot_6trsh")
tuples(Ramanacoil_Golden, Ramanacoil_decrypt, tuple_gold)
ser(Ramanacoil_decrypt, tuple_gold)
decrypt_dicts(Ramanacoil_decrypt, "Ramanacoil/Runic/Ramanacoil_5shot_4trsh")
tuples(Ramanacoil_Golden, Ramanacoil_decrypt, tuple_gold)
ser(Ramanacoil_decrypt, tuple_gold)
decrypt_dicts(Ramanacoil_decrypt, "Ramanacoil/Runic/Ramanacoil_5shot_6trsh")
tuples(Ramanacoil_Golden, Ramanacoil_decrypt, tuple_gold)
ser(Ramanacoil_decrypt, tuple_gold)
